...
Over the years I've written for TechTarget, BrianMadden (RIP), Miradore, MobileIron (Ivanti), CWSI, Wandera, and several other outlets. Linking to these is a losing battle given the nature of the never-static web, and many links get changed or go dark when priorities change. Some content I have saved, link 
