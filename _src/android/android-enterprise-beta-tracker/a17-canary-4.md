...
**Track:** Canary | **Predecessor:** [Canary 3](/android/android-enterprise-beta-tracker/a17-canary-3/) | **Note:** canary builds are forward-looking and may not ship in the next stable release
...
- **Several flags graduated** (enabled) in this build: `addUserInfoInProfileOffDeadlineAlarm`, `checkPersonalSuspensionForAllProfiles`, `crossUserSuspensionEnabledRo`, and others moved to enabled in the canary track
...
- **Personal apps suspension fix** (enabled) - the multi-profile fix for personal apps suspension is now the default behaviour
