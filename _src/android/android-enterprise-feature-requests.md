...
| 17 | Enforce support for DPC migration, and improve UX for customers. | See what [apple are doing](https://9to5mac.com/2023/07/29/an-upgrade-return-to-service-will-increase-mdm-vendor-flexibility/) for comparison. | 🚧 [Partially added](/blog/2024/01/amapi-migrations/) in AMAPI in Jan 2024. <span class="label label-green"><span class="material-symbols-outlined">android</span> 9/11</span> |
