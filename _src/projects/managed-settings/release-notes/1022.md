---
title: MANAGED SETTINGS release 1.0.2.2
...
- Remove deprecated PING API calls
- Add version code to logs

**Fixes**

- Fix for an unnecessary locale SDK version check
...
[Google Play universal APK](https://cdn.bayton.org/download/projects/managed-settings/ms_1022_universal.apk)
