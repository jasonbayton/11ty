---
title: MANAGED SETTINGS release 1.0.0.4
...
- Full rectification for losing the configured support email address via delayed preference setting of the MC value.
