---
title: MANAGED SETTINGS release 1.0.0.8
parent: MANAGED SETTINGS release notes
published: '2024-12-11:00:08'
status: publish
author: 'Jason Bayton'
excerpt: ''
type: project-docs
...
- Added additional analytics, see the privacy policy for details
- Refactored PING service. Improves how usage analytics are sent to the PING service.

**Fixes**

- Pushed fix for occasional incorrect background colour
