---
title: KIOSK APP GENERATOR support
parent: KIOSK APP GENERATOR
...
<div class="support-list">
  <ul>
  {% for post in collections['Kiosk App Generator'] %}
  {% for tag in post.data.categories %}
  {% if tag.includes("Kiosk App Generator Setup") %}
...
<div class="support-list">
  ...
  {% for post in collections['Kiosk App Generator'] %}
  {% for tag in post.data.categories %}
  {% if tag.includes("Kiosk App Generator Configuration") %}
  <li><a href="{{ post.url | url }}">{{ post.data.eleventyNavigation.title }}</a></li>
  {% endif %}
  {% endfor %}
  {% endfor %}
...
<div class="support-list">
  ...
  {% for post in collections['Kiosk App Generator'] %}
  {% for tag in post.data.categories %}
  {% if tag.includes("Kiosk App Generator Troubleshooting") %}
  <li><a href="{{ post.url | url }}">{{ post.data.eleventyNavigation.title }}</a></li>
  {% endif %}
  {% endfor %}
  {% endfor %}
...
KAG is a browser-based tool hosted at [gen.bayton.org/kiosk](https://gen.bayton.org/kiosk/). All builds are produced on the server; nothing is installed locally.
